...
/* --------------------------------
   420 GALLERY — LIGHTBOX & GRID TOGGLE
   -------------------------------- */
(function() {
  ...
  galleryItems.forEach(item => {
    ...
    if (img) imageSources.push(img.src);
  });
  ...
  // Grid toggle (compact ↔ large)
  if (toggleBtn) {
    toggleBtn.addEventListener('click', () => {
      galleryGrid.classList.toggle('large-grid');
    });
  }
})();
